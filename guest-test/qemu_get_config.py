...
print(kernel_img) # shell awk $1
print(initrd_img) # shell awk $2
print(bios_img) # shell awk $3
print(qemu_img) # shell awk $4
print(guest_img) # shell awk $5
print(guest_img_format) # shell awk $6
print(boot_pattern) # shell awk $7
print(guest_root_passwd) # shell awk $8
#print(port) # shell awk $9
